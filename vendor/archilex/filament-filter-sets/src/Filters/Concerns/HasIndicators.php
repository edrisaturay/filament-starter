...
trait HasIndicators
{
    ...
    public function getIndicatorColor(int $index): string
    {
        $colors = $this->getIndicatorColors();
    ...
    protected function buildColumnFilterIndicator(array $filter, FilamentBaseFilter $filterObject, array $columns, string $filterGroupKey, string $filterKey, int $loop, &$indicators): void
    {
    ...
    protected function buildFilterIndicators(array $filter, FilamentBaseFilter $filterObject, array $columns, string $filterGroupKey, string $filterKey, int $loop, &$indicators): void
    {
    ...
    protected function getEvaluatedFilterIndicators(FilamentBaseFilter $filterObject, array $filterData): Indicator | array | string | null
    {
