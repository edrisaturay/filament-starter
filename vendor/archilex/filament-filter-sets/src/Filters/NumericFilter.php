                    ...
                    \Filament\Schemas\Components\Grid::make()
                        ...
                        ->schema([
                            TextInput::make('value')
                                ...
                                ->numeric()
                                ->columnSpan([
                                    'default' => fn (\Filament\Schemas\Components\Utilities\Get $get) => in_array($get('operator'), [NumericOperator::BETWEEN, NumericOperator::NOT_BETWEEN]) ? 1 : 2,
                                    'sm' => function (\Filament\Schemas\Components\Utilities\Get $get, Livewire $livewire) {
                            ...
                            TextInput::make('end')
                                ->hiddenLabel()
                                ->numeric()
                                ->visible(fn (\Filament\Schemas\Components\Utilities\Get $get) => in_array($get('operator'), [NumericOperator::BETWEEN, NumericOperator::NOT_BETWEEN])),
                        ])
                        ->hidden(fn (\Filament\Schemas\Components\Utilities\Get $get) => blank($get('operator')) || in_array($get('operator'), [NumericOperator::POSITIVE, NumericOperator::NEGATIVE]))
                        ->extraAttributes(
